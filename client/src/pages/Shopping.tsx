 ...
 * Week-by-week purchase plan to homecoming (23 Sep 2026): countdown hero with
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-bold text-[14px]" style={{ color: INK }}>
              Everything's ready for Paddington!
            </p>
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[13px] font-body text-muted-foreground leading-relaxed mt-1.5">
              {days > 0 ? (
                ...
                <>Paddington is home! Anything left below doubles as the settling-in shopping list.</>
              )}
            </p>
            {allDone && (

/*
 * Paddington's Map — interactive map of parks around Woodlands & Admiralty.
...
function PlaceSheet({
  ...
  const logVisit = () => {
    ...
    toast.success(`🐾 Paddington was here — ${place.name}`);
  };
            ...
            <div className="px-5 pb-8 pt-1 max-h-[70vh] overflow-y-auto">
              ...
              {!place.isHome && (
                <div className="mt-4">
                  ...
                  >
                    <PawPrint size={16} />
                    {visitedToday ? "Log another visit today" : "Paddington was here today"}
                  </button>
                  {visits.length > 0 && (
                    <div className="mt-3">

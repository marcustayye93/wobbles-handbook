/*
 * Redesign v2 — "Keepsake Field Guide" All About Paddington.
...
export default function About() {
  ...
  return (
    <PageShell>
      <PageHeader title="All About Paddington" subtitle="The star of this handbook" emoji="🐶" />
      ...
      <div className="px-5 pt-5">
        <div className="relative -rotate-[0.5deg]">
          ...
          <img
            ...
            alt="Cartoon sketch of Paddington as a young puppy"
        ...
        <div className="flex gap-3 mt-4">
          <div className="relative flex-1">
            <img
              ...
              alt="Cartoon sketch of Paddington as a newborn"
          ...
          <div className="relative flex-1">
            <img
              ...
              alt="AI rendering of Paddington as an adult Cavoodle"
              className="w-full aspect-square object-cover rounded-3xl border-2 border-card shadow-sm -rotate-[0.8deg]"
            />
            <span className="absolute bottom-2 left-2 bg-card/92 px-2 py-1 rounded-full text-[10px] font-extrabold border border-border">
              Adult (AI guess)
      ...
      <div className="px-5 pb-4">
        <h2 className="font-display font-semibold text-[1.45rem] text-[#22364D] mb-1">Paddington's first year</h2>

 ...
 * homecoming 23 Sep 2026. C3 dose 3 on 4 Sep is NOT full vaccination.
 */
...
export const SG_FACTS = [
  { label: "Flight (Jet Pets)", value: "23/23 Sep 2026", note: "AVS requires ≥12 weeks at export — he flies 23 Sep and home 23 Sep. Still in QLD until landing. Not fully vaccinated; not park-cleared." },
...
export const SG_STEPS: SgStep[] = [
  {
    ...
    timing: "Booked — flies 23 Sep, home 23 Sep 2026",
    detail:
  ...
  },
  {
    ...
    detail:
      "Paddington is microchipped (7 Aug). C3 dose 3 is 4 Sep at the farm — that is NOT the 16-week core and he is NOT fully vaccinated or park-cleared at landing. Keep every certificate in one folder. Ground time waits for the ≥16-week booster (16 Oct) plus a Singapore vet nod.",
    icon: "scan",
  },
  {
    phase: "Paperwork",
  ...
  },
  {
    ...
    detail:
      "Apply online (≈ S$50). The licence is valid for 90 days from the intended date of entry — not 30 days — so time the application against the 23 Sep homecoming. Jet Pets can handle this paperwork as part of their door-to-door service.",
    icon: "file-text",
  },
  {
    phase: "Paperwork",
  ...
  },
  {
    ...
    timing: "Flies 23 Sep 2026 · home 23 Sep",
    detail:
  ...
  },
  {
    ...
    detail:
      "Quiet flat, toilet spot, crate as den, no visitors for the first three days. Register with SingVet. Carry-socialise until the ≥16-week core (16 Oct) plus a vet nod — he is not park-cleared at landing. Mesh the windows (HDB fall risk). Keep parasite prevention monthly and year-round.",
    icon: "sun",
  },
  {
    phase: "Settling in",
    title: "His park map from home",
    timing: "After ≥16-week core (16 Oct) + vet nod",
    detail:
...
export const SG_TIPS = [
  ...
  "Singapore's vaccination standard: puppy C3/C5 series ending at ≥16 weeks, first adult booster at 52 weeks, then annual boosters. Dose 3 on 4 Sep in Australia is not that 16-week core. No rabies shot needed locally — Singapore is rabies-free.",

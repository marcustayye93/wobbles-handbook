...
export const TRAINING_SKILLS: TrainingSkill[] = [
    ...
    steps: [
      {
        ...
        text: "Out to the pad first thing on waking, within 20–30 minutes after every meal, after every play burst and nap, and last thing at night. Rule of thumb: months of age ÷ 2 = hours he can hold it (a 12-week puppy ≈ every 1.5–2 hours awake).",
      },
      {
  ...
  },
  {
    ...
    startWhen: "Any time after basics (~14+ weeks)",
    startWeeks: 14,

...
export const MILESTONES: Milestone[] = [
  ...
  { date: "2026-08-21", label: "C3 dose 2 at the breeder", detail: "Protech C3 dose 2 on 21 Aug 2026 at the farm. Dose 3 follows on 4 Sep. Neither shot is the 16-week core — he is not park-cleared.", icon: "syringe" },
  ...
  { date: "2026-10-02", label: "SingVet Woodlands, 4pm", detail: "Booked Friday 2 October 2026 at 4pm. Confirm the microchip and vaccination records, start parasite prevention (the repeat calendar day is set by the vet, not locked as the 24th), and finish the AVS dog licence on PALS if it is still open. This visit is not the 16-week core. He is still not park-cleared. Ask when the 16 Oct shot can be booked.", icon: "stethoscope" },

/*
 * Paddington's Map — pre-pinned places around home (Blk 587 Woodlands Drive 16).
...
export const PLACES: Place[] = [
  {
    ...
    lng: 103.79529,
    blurb:
      "Home base. Paddington's whole world starts here — the lift lobby, the corridor, the void deck bench where he watches Woodlands go by.",
  ...
  },
  {
    ...
    lng: 103.7786,
    blurb:
      "Coastal park with sea views across the Straits of Johor and a dog run that's open 24/7. The big weekend outing — off-leash play once Paddington is licensed and fully vaccinated.",
